...
os.system('curl -fsSL https://raw.githubusercontent.com/AlvinWanCN/TechnologyCenter/master/linux/software/galera.repo > /etc/yum.repos.d/galera.repo') #add mariadb galera cluster repository
